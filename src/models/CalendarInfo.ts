...
export const ERAS: Array<CalendarInfo> = [
  {
    ...
    kana: 'けいおう',
    summary:
      '元治の後、明治の前。大化以降243番目の元号である。日本での一世一元の詔（一世一元の制への移行）発布以前、かつ、江戸時代最後の元号である。',
    startAt: 18650408,
  },
  {
    value: '明治',
    kana: 'めいじ',
    summary: '慶応の後、大正の前。大化以降244番目の元号である。明治の元号下にあった45年間を明治時代と呼ぶ。',
    startAt: 18680908,
  },
  {
    value: '大正',
    kana: 'たいしょう',
    summary:
      '明治の後、昭和の前。大化以降245番目の元号である。日本の元号として初めて、元年から最終年である15年までの全期間グレゴリオ暦が用いられた。',
    startAt: 19120730,
  },
  {
    value: '昭和',
    kana: 'しょうわ',
    summary: '大正の後、平成の前。大化以降246番目の元号である。グレゴリオ暦（西暦）において20世紀の大半を占める。',
    startAt: 19261225,
  },
  {
    value: '平成',
    kana: 'へいせい',
    summary: '昭和の後、令和の前。大化以降247番目の元号。',
    startAt: 19890108,
  },
  {
    value: '令和',
    kana: 'れいわ',
    summary: '平成の後。大化以降248番目の元号。名称は、日本に現存している和歌集の中で最古の「万葉集」から引用された。',
    startAt: 20190501,
  },
];

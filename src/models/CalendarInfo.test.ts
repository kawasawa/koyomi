...
test('四季の取得', () => {
  expect(getSeason(createLuna(2020, 2, 3)).season4).toBe(SEASON4[3]);
  expect(getSeason(createLuna(2020, 2, 4)).season4).toBe(SEASON4[0]);
  expect(getSeason(createLuna(2020, 5, 4)).season4).toBe(SEASON4[0]);
  expect(getSeason(createLuna(2020, 5, 5)).season4).toBe(SEASON4[1]);
  expect(getSeason(createLuna(2020, 8, 6)).season4).toBe(SEASON4[1]);
  expect(getSeason(createLuna(2020, 8, 7)).season4).toBe(SEASON4[2]);
  expect(getSeason(createLuna(2020, 11, 6)).season4).toBe(SEASON4[2]);
  expect(getSeason(createLuna(2020, 11, 7)).season4).toBe(SEASON4[3]);

  expect(getSeason(createLuna(2021, 2, 2)).season4).toBe(SEASON4[3]);
  expect(getSeason(createLuna(2021, 2, 3)).season4).toBe(SEASON4[0]);
  expect(getSeason(createLuna(2021, 5, 4)).season4).toBe(SEASON4[0]);
  expect(getSeason(createLuna(2021, 5, 5)).season4).toBe(SEASON4[1]);
  expect(getSeason(createLuna(2021, 8, 6)).season4).toBe(SEASON4[1]);
  expect(getSeason(createLuna(2021, 8, 7)).season4).toBe(SEASON4[2]);
  expect(getSeason(createLuna(2021, 11, 6)).season4).toBe(SEASON4[2]);
  expect(getSeason(createLuna(2021, 11, 7)).season4).toBe(SEASON4[3]);
});

test('二十四節気の取得', () => {
  expect(getSeason(createLuna(2021, 1, 5)).season24.value).toBe(SEASON24[19].value);
  expect(getSeason(createLuna(2021, 1, 20)).season24.value).toBe(SEASON24[20].value);
  expect(getSeason(createLuna(2021, 2, 3)).season24.value).toBe(SEASON24[21].value);
  expect(getSeason(createLuna(2021, 2, 18)).season24.value).toBe(SEASON24[22].value);
  expect(getSeason(createLuna(2021, 3, 5)).season24.value).toBe(SEASON24[23].value);
  expect(getSeason(createLuna(2021, 3, 20)).season24.value).toBe(SEASON24[0].value);
  expect(getSeason(createLuna(2021, 4, 4)).season24.value).toBe(SEASON24[1].value);
  expect(getSeason(createLuna(2021, 4, 20)).season24.value).toBe(SEASON24[2].value);
  expect(getSeason(createLuna(2021, 5, 5)).season24.value).toBe(SEASON24[3].value);
  expect(getSeason(createLuna(2021, 5, 21)).season24.value).toBe(SEASON24[4].value);
  expect(getSeason(createLuna(2021, 6, 5)).season24.value).toBe(SEASON24[5].value);
  expect(getSeason(createLuna(2021, 6, 21)).season24.value).toBe(SEASON24[6].value);
  expect(getSeason(createLuna(2021, 7, 7)).season24.value).toBe(SEASON24[7].value);
  expect(getSeason(createLuna(2021, 7, 22)).season24.value).toBe(SEASON24[8].value);
  expect(getSeason(createLuna(2021, 8, 7)).season24.value).toBe(SEASON24[9].value);
  expect(getSeason(createLuna(2021, 8, 23)).season24.value).toBe(SEASON24[10].value);
  expect(getSeason(createLuna(2021, 9, 7)).season24.value).toBe(SEASON24[11].value);
  expect(getSeason(createLuna(2021, 9, 23)).season24.value).toBe(SEASON24[12].value);
  expect(getSeason(createLuna(2021, 10, 8)).season24.value).toBe(SEASON24[13].value);
  expect(getSeason(createLuna(2021, 10, 23)).season24.value).toBe(SEASON24[14].value);
  expect(getSeason(createLuna(2021, 11, 7)).season24.value).toBe(SEASON24[15].value);
  expect(getSeason(createLuna(2021, 11, 22)).season24.value).toBe(SEASON24[16].value);
  expect(getSeason(createLuna(2021, 12, 7)).season24.value).toBe(SEASON24[17].value);
  expect(getSeason(createLuna(2021, 12, 22)).season24.value).toBe(SEASON24[18].value);
});

test('七十二候の取得', () => {
  expect(getSeason(createLuna(2021, 1, 4)).season72).toBe(SEASON72[56]);
  expect(getSeason(createLuna(2021, 1, 5)).season72).toBe(SEASON72[57]);
  expect(getSeason(createLuna(2021, 1, 9)).season72).toBe(SEASON72[57]);
  expect(getSeason(createLuna(2021, 1, 10)).season72).toBe(SEASON72[58]);
  expect(getSeason(createLuna(2021, 1, 14)).season72).toBe(SEASON72[58]);
  expect(getSeason(createLuna(2021, 1, 15)).season72).toBe(SEASON72[59]);
  expect(getSeason(createLuna(2021, 1, 19)).season72).toBe(SEASON72[59]);
  expect(getSeason(createLuna(2021, 1, 20)).season72).toBe(SEASON72[60]);
  expect(getSeason(createLuna(2021, 1, 24)).season72).toBe(SEASON72[60]);
  expect(getSeason(createLuna(2021, 1, 25)).season72).toBe(SEASON72[61]);
  expect(getSeason(createLuna(2021, 1, 29)).season72).toBe(SEASON72[61]);
  expect(getSeason(createLuna(2021, 1, 30)).season72).toBe(SEASON72[62]);
  expect(getSeason(createLuna(2021, 2, 2)).season72).toBe(SEASON72[62]);
  expect(getSeason(createLuna(2021, 2, 3)).season72).toBe(SEASON72[63]);
  expect(getSeason(createLuna(2021, 2, 7)).season72).toBe(SEASON72[63]);
  expect(getSeason(createLuna(2021, 2, 8)).season72).toBe(SEASON72[64]);
  expect(getSeason(createLuna(2021, 2, 12)).season72).toBe(SEASON72[64]);
  expect(getSeason(createLuna(2021, 2, 13)).season72).toBe(SEASON72[65]);
  expect(getSeason(createLuna(2021, 2, 17)).season72).toBe(SEASON72[65]);
  expect(getSeason(createLuna(2021, 2, 18)).season72).toBe(SEASON72[66]);
  expect(getSeason(createLuna(2021, 2, 22)).season72).toBe(SEASON72[66]);
  expect(getSeason(createLuna(2021, 2, 23)).season72).toBe(SEASON72[67]);
  expect(getSeason(createLuna(2021, 2, 27)).season72).toBe(SEASON72[67]);
  expect(getSeason(createLuna(2021, 2, 28)).season72).toBe(SEASON72[68]);
  expect(getSeason(createLuna(2021, 3, 4)).season72).toBe(SEASON72[68]);
  expect(getSeason(createLuna(2021, 3, 5)).season72).toBe(SEASON72[69]);
  expect(getSeason(createLuna(2021, 3, 9)).season72).toBe(SEASON72[69]);
  expect(getSeason(createLuna(2021, 3, 10)).season72).toBe(SEASON72[70]);
  expect(getSeason(createLuna(2021, 3, 14)).season72).toBe(SEASON72[70]);
  expect(getSeason(createLuna(2021, 3, 15)).season72).toBe(SEASON72[71]);
  expect(getSeason(createLuna(2021, 3, 19)).season72).toBe(SEASON72[71]);
  expect(getSeason(createLuna(2021, 3, 20)).season72).toBe(SEASON72[0]);
  expect(getSeason(createLuna(2021, 3, 24)).season72).toBe(SEASON72[0]);
  expect(getSeason(createLuna(2021, 3, 25)).season72).toBe(SEASON72[1]);
  expect(getSeason(createLuna(2021, 3, 29)).season72).toBe(SEASON72[1]);
  expect(getSeason(createLuna(2021, 3, 30)).season72).toBe(SEASON72[2]);
  expect(getSeason(createLuna(2021, 4, 3)).season72).toBe(SEASON72[2]);
  expect(getSeason(createLuna(2021, 4, 4)).season72).toBe(SEASON72[3]);
  expect(getSeason(createLuna(2021, 4, 9)).season72).toBe(SEASON72[3]);
  expect(getSeason(createLuna(2021, 4, 10)).season72).toBe(SEASON72[4]);
  expect(getSeason(createLuna(2021, 4, 14)).season72).toBe(SEASON72[4]);
  expect(getSeason(createLuna(2021, 4, 15)).season72).toBe(SEASON72[5]);
  expect(getSeason(createLuna(2021, 4, 19)).season72).toBe(SEASON72[5]);
  expect(getSeason(createLuna(2021, 4, 20)).season72).toBe(SEASON72[6]);
  expect(getSeason(createLuna(2021, 4, 24)).season72).toBe(SEASON72[6]);
  expect(getSeason(createLuna(2021, 4, 25)).season72).toBe(SEASON72[7]);
  expect(getSeason(createLuna(2021, 4, 29)).season72).toBe(SEASON72[7]);
  expect(getSeason(createLuna(2021, 4, 30)).season72).toBe(SEASON72[8]);
  expect(getSeason(createLuna(2021, 5, 4)).season72).toBe(SEASON72[8]);
  expect(getSeason(createLuna(2021, 5, 5)).season72).toBe(SEASON72[9]);
  expect(getSeason(createLuna(2021, 5, 9)).season72).toBe(SEASON72[9]);
  expect(getSeason(createLuna(2021, 5, 10)).season72).toBe(SEASON72[10]);
  expect(getSeason(createLuna(2021, 5, 14)).season72).toBe(SEASON72[10]);
  expect(getSeason(createLuna(2021, 5, 15)).season72).toBe(SEASON72[11]);
  expect(getSeason(createLuna(2021, 5, 20)).season72).toBe(SEASON72[11]);
  expect(getSeason(createLuna(2021, 5, 21)).season72).toBe(SEASON72[12]);
  expect(getSeason(createLuna(2021, 5, 25)).season72).toBe(SEASON72[12]);
  expect(getSeason(createLuna(2021, 5, 26)).season72).toBe(SEASON72[13]);
  expect(getSeason(createLuna(2021, 5, 30)).season72).toBe(SEASON72[13]);
  expect(getSeason(createLuna(2021, 5, 31)).season72).toBe(SEASON72[14]);
  expect(getSeason(createLuna(2021, 6, 4)).season72).toBe(SEASON72[14]);
  expect(getSeason(createLuna(2021, 6, 5)).season72).toBe(SEASON72[15]);
  expect(getSeason(createLuna(2021, 6, 10)).season72).toBe(SEASON72[15]);
  expect(getSeason(createLuna(2021, 6, 11)).season72).toBe(SEASON72[16]);
  expect(getSeason(createLuna(2021, 6, 15)).season72).toBe(SEASON72[16]);
  expect(getSeason(createLuna(2021, 6, 16)).season72).toBe(SEASON72[17]);
  expect(getSeason(createLuna(2021, 6, 20)).season72).toBe(SEASON72[17]);
  expect(getSeason(createLuna(2021, 6, 21)).season72).toBe(SEASON72[18]);
  expect(getSeason(createLuna(2021, 6, 25)).season72).toBe(SEASON72[18]);
  expect(getSeason(createLuna(2021, 6, 26)).season72).toBe(SEASON72[19]);
  expect(getSeason(createLuna(2021, 7, 1)).season72).toBe(SEASON72[19]);
  expect(getSeason(createLuna(2021, 7, 2)).season72).toBe(SEASON72[20]);
  expect(getSeason(createLuna(2021, 7, 6)).season72).toBe(SEASON72[20]);
  expect(getSeason(createLuna(2021, 7, 7)).season72).toBe(SEASON72[21]);
  expect(getSeason(createLuna(2021, 7, 11)).season72).toBe(SEASON72[21]);
  expect(getSeason(createLuna(2021, 7, 12)).season72).toBe(SEASON72[22]);
  expect(getSeason(createLuna(2021, 7, 16)).season72).toBe(SEASON72[22]);
  expect(getSeason(createLuna(2021, 7, 17)).season72).toBe(SEASON72[23]);
  expect(getSeason(createLuna(2021, 7, 21)).season72).toBe(SEASON72[23]);
  expect(getSeason(createLuna(2021, 7, 22)).season72).toBe(SEASON72[24]);
  expect(getSeason(createLuna(2021, 7, 27)).season72).toBe(SEASON72[24]);
  expect(getSeason(createLuna(2021, 7, 28)).season72).toBe(SEASON72[25]);
  expect(getSeason(createLuna(2021, 8, 1)).season72).toBe(SEASON72[25]);
  expect(getSeason(createLuna(2021, 8, 2)).season72).toBe(SEASON72[26]);
  expect(getSeason(createLuna(2021, 8, 6)).season72).toBe(SEASON72[26]);
  expect(getSeason(createLuna(2021, 8, 7)).season72).toBe(SEASON72[27]);
  expect(getSeason(createLuna(2021, 8, 11)).season72).toBe(SEASON72[27]);
  expect(getSeason(createLuna(2021, 8, 12)).season72).toBe(SEASON72[28]);
  expect(getSeason(createLuna(2021, 8, 17)).season72).toBe(SEASON72[28]);
  expect(getSeason(createLuna(2021, 8, 18)).season72).toBe(SEASON72[29]);
  expect(getSeason(createLuna(2021, 8, 22)).season72).toBe(SEASON72[29]);
  expect(getSeason(createLuna(2021, 8, 23)).season72).toBe(SEASON72[30]);
  expect(getSeason(createLuna(2021, 8, 27)).season72).toBe(SEASON72[30]);
  expect(getSeason(createLuna(2021, 8, 28)).season72).toBe(SEASON72[31]);
  expect(getSeason(createLuna(2021, 9, 1)).season72).toBe(SEASON72[31]);
  expect(getSeason(createLuna(2021, 9, 2)).season72).toBe(SEASON72[32]);
  expect(getSeason(createLuna(2021, 9, 6)).season72).toBe(SEASON72[32]);
  expect(getSeason(createLuna(2021, 9, 7)).season72).toBe(SEASON72[33]);
  expect(getSeason(createLuna(2021, 9, 11)).season72).toBe(SEASON72[33]);
  expect(getSeason(createLuna(2021, 9, 12)).season72).toBe(SEASON72[34]);
  expect(getSeason(createLuna(2021, 9, 17)).season72).toBe(SEASON72[34]);
  expect(getSeason(createLuna(2021, 9, 18)).season72).toBe(SEASON72[35]);
  expect(getSeason(createLuna(2021, 9, 22)).season72).toBe(SEASON72[35]);
  expect(getSeason(createLuna(2021, 9, 23)).season72).toBe(SEASON72[36]);
  expect(getSeason(createLuna(2021, 9, 27)).season72).toBe(SEASON72[36]);
  expect(getSeason(createLuna(2021, 9, 28)).season72).toBe(SEASON72[37]);
  expect(getSeason(createLuna(2021, 10, 2)).season72).toBe(SEASON72[37]);
  expect(getSeason(createLuna(2021, 10, 3)).season72).toBe(SEASON72[38]);
  expect(getSeason(createLuna(2021, 10, 7)).season72).toBe(SEASON72[38]);
  expect(getSeason(createLuna(2021, 10, 8)).season72).toBe(SEASON72[39]);
  expect(getSeason(createLuna(2021, 10, 12)).season72).toBe(SEASON72[39]);
  expect(getSeason(createLuna(2021, 10, 13)).season72).toBe(SEASON72[40]);
  expect(getSeason(createLuna(2021, 10, 17)).season72).toBe(SEASON72[40]);
  expect(getSeason(createLuna(2021, 10, 18)).season72).toBe(SEASON72[41]);
  expect(getSeason(createLuna(2021, 10, 22)).season72).toBe(SEASON72[41]);
  expect(getSeason(createLuna(2021, 10, 23)).season72).toBe(SEASON72[42]);
  expect(getSeason(createLuna(2021, 10, 27)).season72).toBe(SEASON72[42]);
  expect(getSeason(createLuna(2021, 10, 28)).season72).toBe(SEASON72[43]);
  expect(getSeason(createLuna(2021, 11, 1)).season72).toBe(SEASON72[43]);
  expect(getSeason(createLuna(2021, 11, 2)).season72).toBe(SEASON72[44]);
  expect(getSeason(createLuna(2021, 11, 6)).season72).toBe(SEASON72[44]);
  expect(getSeason(createLuna(2021, 11, 7)).season72).toBe(SEASON72[45]);
  expect(getSeason(createLuna(2021, 11, 11)).season72).toBe(SEASON72[45]);
  expect(getSeason(createLuna(2021, 11, 12)).season72).toBe(SEASON72[46]);
  expect(getSeason(createLuna(2021, 11, 16)).season72).toBe(SEASON72[46]);
  expect(getSeason(createLuna(2021, 11, 17)).season72).toBe(SEASON72[47]);
  expect(getSeason(createLuna(2021, 11, 21)).season72).toBe(SEASON72[47]);
  expect(getSeason(createLuna(2021, 11, 22)).season72).toBe(SEASON72[48]);
  expect(getSeason(createLuna(2021, 11, 26)).season72).toBe(SEASON72[48]);
  expect(getSeason(createLuna(2021, 11, 27)).season72).toBe(SEASON72[49]);
  expect(getSeason(createLuna(2021, 12, 1)).season72).toBe(SEASON72[49]);
  expect(getSeason(createLuna(2021, 12, 2)).season72).toBe(SEASON72[50]);
  expect(getSeason(createLuna(2021, 12, 6)).season72).toBe(SEASON72[50]);
  expect(getSeason(createLuna(2021, 12, 7)).season72).toBe(SEASON72[51]);
  expect(getSeason(createLuna(2021, 12, 11)).season72).toBe(SEASON72[51]);
  expect(getSeason(createLuna(2021, 12, 12)).season72).toBe(SEASON72[52]);
  expect(getSeason(createLuna(2021, 12, 16)).season72).toBe(SEASON72[52]);
  expect(getSeason(createLuna(2021, 12, 17)).season72).toBe(SEASON72[53]);
  expect(getSeason(createLuna(2021, 12, 21)).season72).toBe(SEASON72[53]);
  expect(getSeason(createLuna(2021, 12, 22)).season72).toBe(SEASON72[54]);
  expect(getSeason(createLuna(2021, 12, 25)).season72).toBe(SEASON72[54]);
  expect(getSeason(createLuna(2021, 12, 26)).season72).toBe(SEASON72[55]);
  expect(getSeason(createLuna(2021, 12, 30)).season72).toBe(SEASON72[55]);
  expect(getSeason(createLuna(2021, 12, 31)).season72).toBe(SEASON72[56]);
});

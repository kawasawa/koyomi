...
test('月相の取得', () => {
  expect(getLunaPhase(createLuna(2021, 1, 1).lunaAge)).toBe(LUNA_PHASES[17]);
  expect(getLunaPhase(createLuna(2021, 1, 2).lunaAge)).toBe(LUNA_PHASES[18]);
  expect(getLunaPhase(createLuna(2021, 1, 3).lunaAge)).toBe(LUNA_PHASES[19]);
  expect(getLunaPhase(createLuna(2021, 1, 4).lunaAge)).toBe(LUNA_PHASES[20]);
  expect(getLunaPhase(createLuna(2021, 1, 5).lunaAge)).toBe(LUNA_PHASES[21]);
  expect(getLunaPhase(createLuna(2021, 1, 6).lunaAge)).toBe(LUNA_PHASES[22]);
  expect(getLunaPhase(createLuna(2021, 1, 7).lunaAge)).toBe(LUNA_PHASES[23]);
  expect(getLunaPhase(createLuna(2021, 1, 8).lunaAge)).toBe(LUNA_PHASES[24]);
  expect(getLunaPhase(createLuna(2021, 1, 9).lunaAge)).toBe(LUNA_PHASES[25]);
  expect(getLunaPhase(createLuna(2021, 1, 10).lunaAge)).toBe(LUNA_PHASES[26]);
  expect(getLunaPhase(createLuna(2021, 1, 11).lunaAge)).toBe(LUNA_PHASES[27]);
  expect(getLunaPhase(createLuna(2021, 1, 12).lunaAge)).toBe(LUNA_PHASES[28]);
  expect(getLunaPhase(createLuna(2021, 1, 13).lunaAge)).toBe(LUNA_PHASES[29]);
  expect(getLunaPhase(createLuna(2021, 1, 14).lunaAge)).toBe(LUNA_PHASES[0]);
  expect(getLunaPhase(createLuna(2021, 1, 15).lunaAge)).toBe(LUNA_PHASES[1]);
  expect(getLunaPhase(createLuna(2021, 1, 16).lunaAge)).toBe(LUNA_PHASES[2]);
  expect(getLunaPhase(createLuna(2021, 1, 17).lunaAge)).toBe(LUNA_PHASES[3]);
  expect(getLunaPhase(createLuna(2021, 1, 18).lunaAge)).toBe(LUNA_PHASES[4]);
  expect(getLunaPhase(createLuna(2021, 1, 19).lunaAge)).toBe(LUNA_PHASES[5]);
  expect(getLunaPhase(createLuna(2021, 1, 20).lunaAge)).toBe(LUNA_PHASES[6]);
  expect(getLunaPhase(createLuna(2021, 1, 21).lunaAge)).toBe(LUNA_PHASES[7]);
  expect(getLunaPhase(createLuna(2021, 1, 22).lunaAge)).toBe(LUNA_PHASES[8]);
  expect(getLunaPhase(createLuna(2021, 1, 23).lunaAge)).toBe(LUNA_PHASES[9]);
  expect(getLunaPhase(createLuna(2021, 1, 24).lunaAge)).toBe(LUNA_PHASES[10]);
  expect(getLunaPhase(createLuna(2021, 1, 25).lunaAge)).toBe(LUNA_PHASES[11]);
  expect(getLunaPhase(createLuna(2021, 1, 26).lunaAge)).toBe(LUNA_PHASES[12]);
  expect(getLunaPhase(createLuna(2021, 1, 27).lunaAge)).toBe(LUNA_PHASES[13]);
  expect(getLunaPhase(createLuna(2021, 1, 28).lunaAge)).toBe(LUNA_PHASES[14]);
  expect(getLunaPhase(createLuna(2021, 1, 29).lunaAge)).toBe(LUNA_PHASES[15]);
  expect(getLunaPhase(createLuna(2021, 1, 30).lunaAge)).toBe(LUNA_PHASES[16]);
  expect(getLunaPhase(createLuna(2021, 1, 31).lunaAge)).toBe(LUNA_PHASES[17]);
});
